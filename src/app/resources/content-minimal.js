...
const about = {
    ...
    intro: {
        ...
        description:
            <>
                <p>Lavell is a New York-based DevOps Cloud Engineer with a passion for transforming complex challenges into simple, elegant design solutions. His work spans digital interfaces, interactive experiences, and the convergence of design and technology.</p>
                <p>Orchestrated a seamless cloud migration leveraging AWS VPC, Auto Scaling, ELB, and EFS, resulting in a 25% increase in system efficiency and significant cost saving.</p>
            </>
    },
    work: {
        ...
        experiences: [
            {
                ...
                role: 'DevOps Cloud Engineer',
                achievements: [
                    <>Leveraged AWS core services, including EC2, S3, and CloudFormation, to develop a unified design system, enhancing design consistency by 40% and boosting operational efficiency across multiple platforms through DevOps practices.</>,
                    <>Utilized AWS core services such as Lambda, DynamoDB, and CloudFront to develop a cohesive design system, increasing design consistency by 35% and streamlining operations through advanced DevOps methodologies.</>
                ],
